...
export default function ProfileCard({
    ...
    role = "Global Outreach Ministry",
    email = "info@kingdommandate.org",
    avatarSrc = "https://images.unsplash.com/photo-1511632765486-a01980e01a18?w=400&h=400&fit=crop",
    statusText = "Reaching the Nations",
    statusColor = "bg-blue-500",
    glowText = "Driven by Divine Mandate",
    className,
    primaryActionText = "Partner with Us",
    secondaryActionText = "Contact Ministry",
    onPrimaryClick,
}: ComponentProps) {
    ...
    return (
        ...
        >
            ...
            <div className="pointer-events-none absolute inset-x-0 -bottom-10 top-[72%] rounded-[28px] bg-blue-400/90 blur-0 shadow-[0_40px_80px_-16px_rgba(96,165,250,0.8)] z-0" />
            ...
            <Card className="relative z-10 mx-auto w-full max-w-3xl overflow-visible rounded-[28px] border-0 bg-[radial-gradient(120%_120%_at_30%_10%,#1a1a1a_0%,#0f0f10_60%,#0b0b0c_100%)] text-white shadow-2xl">
                <CardContent className="p-6 sm:p-8">
                    ...
                    <div className="mt-6 grid grid-cols-1 gap-4 sm:grid-cols-2">
                        ...
                        >
                            <Plus className="h-4 w-4" /> {primaryActionText}
                        </Button>
                        ...
                        <Button
                            ...
                            className="h-12 justify-start gap-3 rounded-2xl bg-white/10 text-white hover:bg-white/15"
                        >
                            <Copy className="h-4 w-4" /> {copied ? "Copied" : secondaryActionText}
                        </Button>
                    </div>
                </CardContent>
            </Card>
